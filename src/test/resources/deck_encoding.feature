Feature: Deck encoding
  ...
  Scenario Outline: Encoding the deck into the varint
    ...
    Examples:
      | cards                                   | values                        |
      | 3:01DE001                               | 1,1,1,0,1                     |
      | 3:01DE001,3:01DE002                     | 1,2,1,0,1,2                   |
      | 3:01DE001,3:01DE002,3:01NX009           | 2,1,1,3,9,2,1,0,1,2           |
      | 2:01DE001                               | 1,1,1,0,1                     |
      | 2:01DE001,2:01DE002                     | 1,2,1,0,1,2                   |
      | 2:01DE001,2:01DE002,2:01NX009           | 2,1,1,3,9,2,1,0,1,2           |
      | 1:01DE001                               | 1,1,1,0,1                     |
      | 1:01DE001,1:01DE002                     | 1,2,1,0,1,2                   |
      | 1:01DE001,1:01DE002,1:01NX009           | 2,1,1,3,9,2,1,0,1,2           |
      | 3:01DE001,2:01DE002                     | 1,1,1,0,1,1,1,1,0,2           |
